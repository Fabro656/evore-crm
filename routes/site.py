...
MODULES = {
    ...
    'contabilidad': {
        'name': 'Contabilidad', 'label': 'Contabilidad PUC',
        'headline': 'Contabilidad colombiana,\nautomatizada.',
        'tagline': 'Plan Único de Cuentas con 102 cuentas, asientos automáticos y reportes fiscales.',
        'subline': 'Cada venta y orden de compra genera asientos contables automáticamente. Balances, estado de resultados, flujo de caja y retenciones al día.',
        'features': [
            {'label': 'Asientos automáticos', 'title': 'Vendes → se contabiliza solo.',
             'desc': 'Al crear una venta o confirmar una OC, el sistema genera el asiento contable con las cuentas PUC correctas. Sin intervención del contador.',
             'checks': ['PUC completo Decreto 2650/1993', 'Asiento de ingreso al confirmar venta', 'Asiento de egreso al crear OC'],
             'cards': [
                 {'icon': 'bi-arrow-down-circle', 'color': '#2E844A', 'title': 'Ingreso VT-2026-089', 'sub': 'Textiles del Norte · Confirmado', 'value': '$12.5M'},
                 {'icon': 'bi-arrow-up-circle', 'color': '#C23934', 'title': 'Egreso OC-2026-034', 'sub': 'Químicos S.A. · Anticipo', 'value': '$3.2M'},
                 {'icon': 'bi-journal-check', 'color': '#0176D3', 'title': 'Balance de prueba', 'sub': 'Abril 2026 · 102 cuentas', 'value': 'OK'},
             ]},
        ],
        'stats': [
            {'value': '102', 'label': 'Cuentas PUC'},
            {'value': 'Auto', 'label': 'Asientos contables'},
            {'value': '6', 'label': 'Reportes financieros'},
        ]
    },
    'nomina': {

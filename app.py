    ...
    def _tenant_filter(execute_state):
        ...
        try:
            for mapper in execute_state.all_mappers:
                ...
                if entity.__tablename__ in ('companies', 'user_companies', 'company_relationships', 'users', 'chat_rooms', 'chat_participants', 'chat_messages', 'suscripciones', 'foro_publicaciones', 'foro_valoraciones', 'foro_apelaciones'):
                    continue
